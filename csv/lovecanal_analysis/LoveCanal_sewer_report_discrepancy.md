...
document repository:
- **2013 EPA Third Five-Year Review** (p18): "residual contamination which had migrated
  from the original disposal area years ago"; the pipe joints "had become compromised
  allowing materials to seep out," and the bedding "had been impacted by historical
  materials that appeared to have NAPL consistency."
- **2019 EPA Fourth Five-Year Review** (p12) and the **2018, 2019, 2020, 2022 Periodic
  Review Reports**: the NAPL "was observed sporadically during the sewer repair
  activities, was likely **limited in volume and mobility**." MW-3 (set in the repaired
  bedding) showed "no NAPL or visible sheen" from 2011 through 2018.
- Regulatory framing (per EPA/press): the contamination was **"not a result of current
  operations,"** "isolated within a low-lying section... embedded within clay soils
  which restrict migration."

That is the uniform, propagated conclusion: limited, residual, stationary, old, contained.

## What is NOT in the official archive (the "two directions / pouring in" version)
- A full-text search of all **176 archived DEC documents** found **no** account of NAPL
...
work. The complaints describe **"signature Love Canal contaminants, including... NAPL, a
toxic chemical 'stew'"** found within ~250 ft of the containment boundary — an active,
alarming characterization, opposite in tone to the official "residual/limited" language.

## Assessment
The discrepancy is real in STRUCTURE, and it is the kind of thing that warrants scrutiny:
- The **primary observational report (SSIR) is withheld from the public archive**; only its
  sanitized *conclusion* ("limited in volume and mobility") propagates through every
  downstream official document.
- The alarming "two directions / pouring in" characterization — if it exists in a
  document — would be in that SSIR or in a court filing / deposition, NOT in the public
...
3. Compare the SSIR's raw field observations against the "limited volume and mobility"
   conclusion that the FYRs and PRRs repeat — that is the exact point of the discrepancy.

## Sources
- Archived: EPA 2nd/3rd/4th Five-Year Reviews; LC Periodic Review Reports 2018-2022;
  2011 Colvin work plans (`docs/DecDocs_932020_archive/`).
- Buffalo News (2021-01-26, T.J. Prohaska); Courthouse News "Years Later, Love Canal Stew
  Bubbles Up"; Niagara Gazette "Love Canal suit tied to 2011 sewer work".
